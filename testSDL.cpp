...
const int MINE_VALUE            = 20;    // Giá trị thể hiện một ô đang có mìn

const int SPRITE_CELL_WIDTH     = 16;   // Chiều rộng gốc của một ô
const int SPRITE_CELL_HEIGHT    = 16;   // Chiều cao gốc của một ô

const int WINDOW_CELL_WIDTH     = 30;   // Chiều rộng khi hiển thị của một ô
const int WINDOW_CELL_HEIGHT    = 30;   // Chiều cao khi hiển thị của một ô

const int DEFAULT_NUM_ROWS      = 20;    // Số lượng ô theo chiều ngang
const int DEFAULT_NUM_COLS      = 20;    // Số lượng ô theo chiều dọc
const int DEFAULT_NUM_MINES     = 45;   // Số lượng mìn
